  ...
  return (
    <section ref={containerRef} className="relative w-full overflow-hidden bg-white">
      <div className="relative w-full h-screen flex items-center justify-center">
        ...
        <div className="absolute inset-0 max-w-7xl mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center justify-between pt-[100px] pb-10 lg:py-0 pointer-events-none z-10">
